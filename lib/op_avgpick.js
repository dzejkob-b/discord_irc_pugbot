    ...
    exec(channelKey) {
        ...
        if (operRef.logicState == 2 || operRef.logicState == 1) {
            ...
            operRef.gameRef.restCat.addStatusReadableStats(operRef.statsRef, function() {
                ...
                wRef = operRef.gameRef.restCat.addStatusReadable(wRef, true, operRef.voteRef, channelKey, operRef, true);
            ...
            if (catRef != null) {
                catRef.addStatusReadableStats(operRef.statsRef, function() {
                    ...
                    tmList.push(catRef.addStatusReadable(WordCo.cre(), false, operRef.voteRef, channelKey, operRef, true));
