...
class OpDeletePug {
    ...
    exec(channelKey) {
        ...
        if (!operRef.anyCats(channelKey)) {
            ...
            (operRef.gameRef == null ||
                catRef.flag == operRef.gameRef.restCat.flag) &&
            ...
            partRef.noticeMessage(
                ...
                WordCo.cre()
                    ...
                    .texth(catRef.flag)
                    .text(
                        ' pug now - captain or player picking allready started!'
                    )
            );
        } else {
