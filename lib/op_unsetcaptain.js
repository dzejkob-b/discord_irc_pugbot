...
class OpUnsetCaptain {
    ...
    exec(channelKey) {
        let operRef = this.parent, acRef = operRef.getAction(channelKey), teamRef, teamColor, wRef, cStk = this.parent.cStk, partRef = this.parent.partRef, privPartRef = this.parent.privPartRef;
