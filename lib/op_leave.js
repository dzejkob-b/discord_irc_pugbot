...
class OpLeave {
    ...
    exec(channelKey) {
        ...
        if (!operRef.anyCats(channelKey)) {
            ...
            result = catRef.leaveParticipantCooldown(operRef.gameRef, partRef);
            reason = cStk.pop();
            ...
            if (result == -1) {
                ...
                operRef.gameRef.restCat.flag == catRef.flag
            ) {
                // msg to all
                ...
                // const isCaptain = operRef.gameRef.getTeamByCaptain(partRef) != null;
