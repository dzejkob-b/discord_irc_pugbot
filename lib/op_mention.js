    ...
    exec(channelKey) {
        ...
        operRef.getUser(cStk.pop(), (cPartRef) => {
            ...
            if (cPartRef == null) {
                ...
                operRef.msgRef.sendMsg(channelKey, WordCo.cre().textNick(cPartRef.nick, false, cPartRef.getDiscordId()).text(', ' + reason), privPartRef);
                ...
                operRef.msgRef.sendMsg(channelKey, WordCo.cre().textNick(cPartRef.nick, false, cPartRef.getDiscordId()).text(' !'), privPartRef);
            }
