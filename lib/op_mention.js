    ...
    exec() {
        ...
        operRef.getUser(cStk.pop(), (cPartRef) => {
            ...
            if (cPartRef == null) {
                ...
                operRef.sendMsg(false, WordCo.cre().textNick(cPartRef.nick, false, cPartRef.getDiscordId()).text(', ' + reason), privPartRef);
                ...
                operRef.sendMsg(false, WordCo.cre().textNick(cPartRef.nick, false, cPartRef.getDiscordId()).text(' !'), privPartRef);
            }
