        ...
        if (this.logicState == 0) {
            ...
            if (this.gameRef.teams.length == 0) {
                ...
                this.gameRef.doPickCaptains(this.operRef, this.voteRef, () => {
                    ...
                    self.gameRef.restCat.loadAvgPick(self.operRef.statsRef, false, function(aMth) {
                        wRef = self.gameRef.restCat.addStatusReadableAvgPick(aMth, wRef, true, self.voteRef, chk, self.operRef);
                        tmList.push(wRef);
