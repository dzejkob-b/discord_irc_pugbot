						...
						while (idx < self.gameRef.teams.length) {
							...
							if (teamRef.captPartRef.captainSetMethod) {
								...
								switch (teamRef.captPartRef.captainSetMethod) {
									...
									case "avgpick_rnd":
										cptSetFlag = "Random suitable captain";
										break;

									case "avgpick_oth":
										cptSetFlag = "Other captain";
										break;

									case "voted" :
										cptSetFlag = "Voted captain";
										break;
								}
								...
								if (teamRef.captPartRef.avgTotPick) {
									wRef
										...
										.texth("[")
										.text(
											cptSetFlag ? cptSetFlag + " avg pick: " : "Avg pick: "
										)
										.text(teamRef.captPartRef.avgPick)
										.texth("/")
										.text(teamRef.captPartRef.avgTotPick)
										.texth("]")
										.text(" ");
								} else if (cptSetFlag) {
									wRef
