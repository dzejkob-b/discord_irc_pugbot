...
class OpTurn {
    ...
    exec(channelKey) {
        let operRef = this.parent, acRef = operRef.getAction(channelKey), teamRef, tmList = [], wRef, cStk = this.parent.cStk, partRef = this.parent.partRef, privPartRef = this.parent.privPartRef;
