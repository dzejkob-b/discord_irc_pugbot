...
class Rules {
    ...
    getRules(channelKey, singleRuleNumb = false) {
        ...
        if (partRef != null && partRef.type == 1 && (tmpList = operRef.getTextCommand(channelKey, "ircRulesShow")) != false && tmpList.length > 0) {
            ...
            } while (tmpList || operRef.isCommandExist(channelKey, "rule" + (ruleNumb - 1), false));
        }
