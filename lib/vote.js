...
class VoteOperator {
    ...
    findJoinedParticipant(partRef) {
        ...
        if (this.operRef.logicState > 1) {
            ...
            while (cPartRef == null && idx < this.operRef.cats.length) {
                ...
                if ((cPartRef = this.operRef.cats[idx].getParticipant(partRef)) == null) {
                    idx++;
                }
            }
        }
    ...
    getParticipantForVoteNickOrForceIndex(input) {
        ...
        if (this.operRef.logicState > 1) {
            cPartRef = this.operRef.gameCatRef.getParticipantNickOrForceIndex(input);
            cCatRef = this.operRef.gameCatRef;
            ...
            while (cPartRef == null && idx < this.operRef.cats.length) {
                ...
                if ((cPartRef = this.operRef.cats[idx].getParticipantNickOrForceIndex(input)) == null) {
                    idx++;
                }
            }
        }
