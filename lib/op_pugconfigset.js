        ...
        switch (subCmdLowerCase) {
            ...
            case 'limitnocapttag':
                ...
                if (parseInt(value) > maxNoCapt) {
                    operRef.sendMsg(channelKey, WordCo.cre().text(Catalog.SUBCOMMANDS[subCmd]['readable']).text(` value exceed maximum allowed for the pug. For disabling set the value of '0'`), privPartRef);
                }
