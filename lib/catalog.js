...
class Catalog {
    ...
    static fromJSON(input) {
        ...
        ["channelKey", "flag", "playerLimit", "teamCount", "isQuick", "createTime", "touchTime", "pickSteps", "possibleVotes", "captainIdleInSecs", "captainIdleCooldownInSecs", "playerRejoinCooldownInSecs", "limitNoCaptTag", "avgPickStatsMethod"].forEach(c => {
