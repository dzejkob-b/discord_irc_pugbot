...
class Catalog {
    ...
    static fromJSON(input) {
        ...
        ["channelKey", "flag", "playerLimit", "teamCount", "isQuick", "createTime", "touchTime", "possibleVotes", "captainIdleInSecs", "captainIdleCooldownInSecs", "playerRejoinCooldownInSecs"].forEach(c => {
    ...
    leaveParticipant(gameRef, partRef, forceNoCooldown = false, secs = false, isCaptainIdle = false) {
        let idx = this.findParticipant(partRef);
        ...
        if (idx == -1) {
            ...
            if (!forceNoCooldown && gameRef.areCaptainsSet) {
    ...
    leaveParticipantList(gameRef, list) {
        list.forEach((partRef, idx) => {
            this.leaveParticipant(gameRef, partRef, true);
        });
    }
