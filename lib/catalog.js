...
class Catalog {
    ...
    constructor(channelKey, flag, playerLimit, teamCount, parentCatRef, extraSettings) {
        ...
        this.pickSteps = this.extraSettings.pickSteps || Catalog.DEFAULT_PICK_STEPS;
        this.possibleVotes = this.extraSettings.possibleVotes || Catalog.DEFAULT_POSSIBLE_VOTES;
        this.captainIdleInSecs = this.extraSettings.captainIdleInSecs || Catalog.DEFAULT_CAPTAIN_IDLE_IN_SECS;
        this.captainIdleCooldownInSecs = this.extraSettings.captainIdleCooldownInSecs || Catalog.DEFAULT_CAPTAIN_IDLE_COOLDOWN_IN_SECS;
        this.playerRejoinCooldownInSecs = this.extraSettings.playerRejoinCooldownInSecs || Catalog.DEFAULT_PLAYER_REJOIN_COOLDOWN_IN_SECS;
    }
    ...
    static fromJSON(input) {
        ...
        ["channelKey", "flag", "playerLimit", "teamCount", "isQuick", "createTime", "touchTime", "pickSteps", "possibleVotes", "captainIdleInSecs", "captainIdleCooldownInSecs", "playerRejoinCooldownInSecs"].forEach(c => {
    ...
    loadAvgPick(statsRef, callback, filterCallback) {
        ...
        if (!this.list || this.list.length == 0) {
            ...
            statsRef.sumRef.getStatsMultiple(this.flag, this.list, function(rows) {
                    ...
                    rows.forEach((row) => {
                        ...
                        if (brk) {
                            ...
                            if (tPugs > 0) {
                                ...
                                if (!filterCallback || filterCallback(tPugs, tAvgPick, tAvgTotPick)) {
