...
class Catalog {
    ...
    constructor(channelKey, flag, playerLimit, teamCount, parentCatRef, extraSettings) {
        ...
        if (extraSettings) {
            for (var c of ['pickSteps', 'possibleVotes', 'captainIdleInSecs', 'captainIdleCooldownInSecs', 'playerRejoinCooldownInSecs', 'limitNoCaptTag']) {
    ...
    static fromJSON(input) {
        ...
        ["channelKey", "flag", "playerLimit", "teamCount", "isQuick", "createTime", "touchTime", "pickSteps", "possibleVotes", "captainIdleInSecs", "captainIdleCooldownInSecs", "playerRejoinCooldownInSecs", "limitNoCaptTag"].forEach(c => {
