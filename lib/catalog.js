...
class Catalog {
    ...
    constructor(channelKey, flag, playerLimit, teamCount, parentCatRef, extraSettings) {
        ...
        this.pickSteps = extraSettings && extraSettings.pickSteps || Catalog.DEFAULT_PICK_STEPS;
        this.possibleVotes = extraSettings && extraSettings.possibleVotes || Catalog.DEFAULT_POSSIBLE_VOTES;
        this.captainIdleInSecs = extraSettings && extraSettings.captainIdleInSecs || Catalog.DEFAULT_CAPTAIN_IDLE_IN_SECS;
        this.captainIdleCooldownInSecs = extraSettings && extraSettings.captainIdleCooldownInSecs || Catalog.DEFAULT_CAPTAIN_IDLE_COOLDOWN_IN_SECS;
        this.playerRejoinCooldownInSecs = extraSettings && extraSettings.playerRejoinCooldownInSecs || Catalog.DEFAULT_PLAYER_REJOIN_COOLDOWN_IN_SECS;
    }
