...
class OpList {
    ...
    exec(channelKey) {
        let operRef = this.parent, catRef, wRef, acRef, teamRef, hist, chCats, tmList = [], useChan, cStk = this.parent.cStk, partRef = this.parent.partRef, privPartRef = this.parent.privPartRef;
        ...
        if ((acRef = operRef.getAction(channelKey)) != null && (acRef.logicState == 2 || acRef.logicState == 1)) {
            ...
            if ((catRef = operRef.getCatRef(false, cStk.last())) == null) {
                ...
                tmList.push(catRef.addStatusReadable(WordCo.cre(), false, acRef.voteRef, channelKey, operRef));
            }
            ...
            if (operRef.currentCmd == 'liast' || operRef.currentCmd == 'liastall') {
                ...
                operRef.statsRef.getGameStat(useChan, false, null, 0, function(st_rows, pl_rows) {
