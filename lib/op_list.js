...
class OpList {
    ...
    exec(channelKey) {
        let operRef = this.parent, catRef, tmList = [], wRef, teamRef, hist, chCats, useChan, cStk = this.parent.cStk, partRef = this.parent.partRef, privPartRef = this.parent.privPartRef;
