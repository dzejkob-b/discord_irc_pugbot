...
class OpList {
    ...
    exec(channelKey) {
        let operRef = this.parent, catRef, wRef, teamRef, hist, chCats, tmList = [], useChan, cStk = this.parent.cStk, partRef = this.parent.partRef, privPartRef = this.parent.privPartRef;
