        ...
        if (!operRef.anyCats(channelKey)) {
            ...
            operRef.getUser(cStk.pop(), (cPartRef) => {
                ...
                if (cPartRef == null) {
                    ...
                    result = catRef.joinParticipant(cPartRef, false, false, true);
                    ...
                    if (result == -1) {
                        ...
                        // msg to all
                        operRef.sendMsg(channelKey, WordCo.cre().text('Player ').texth(cPartRef.nick).text(' was added to ').texth(catRef.flag).text(' pug.'), privPartRef);
                    }
