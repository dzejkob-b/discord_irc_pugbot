...
class Welcome {
    ...
    getMessage(cPartRef) {
        ...
        } else if (cPartRef.type == 0 && this.operRef.options.welcomeMessageDiscord) {
    ...
    loadState() {
        ...
        if (fs.existsSync("welcome.json") && (data = fs.readFileSync('welcome.json', 'utf8')) != false && (dt = JSON.parse(data))) {
