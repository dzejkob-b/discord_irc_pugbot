...
class OpBanDef {
    ...
    exec() {
        let operRef = this.parent, banNick, banKey, cStk = this.parent.cStk, partRef = this.parent.partRef;
        ...
        operRef.getUser(banNick = cStk.pop(), (cPartRef) => {
            ...
            if (typeof operRef.banUsers[banKey] == 'undefined') {
                ...
                var c = operRef.banUsers[banKey], cmd = '.ban ';
                ...
                partRef.noticeMessage(operRef, WordCo.cre().text('Ban command: ').texth(cmd));
            }
