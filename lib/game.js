...
class Game {
    ...
    constructor(channelKey, catRef, teamCount, extraSettings) {
        ...
        if (catRef) {
            ...
            this.captainIdleInSecs = extraSettings.captainIdleInSecs; // todo: should probably put in another place
    ...
    isCaptain(partRef) {
        const result = this.teams.some(t => t.captPartRef.id == partRef.id);
        return result;
    }
