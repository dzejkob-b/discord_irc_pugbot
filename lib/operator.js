import fs from "fs";
import TextCommand from "./text_command.js";
import Participant from "./participant.js";
import Catalog from "./catalog.js";
import WordCo from "./word_co.js";
import CmdStack from "./cmd_stack.js";
import Nouns from "./nouns.js";
import Stats from "./stats.js";
import Welcome from "./welcome.js";
import ChannelAction from "./channel_action.js";
...
import OpDelTimeout from "./op_deltimeout.js";
...
class Operator {
	...
	getCatRef(channelKey, flag, fallbackChannelKey) {
		...
		if (flag) {
			...
			const defaultPugs = chCats.filter((cat) => cat.getIsDefault());
			if (defaultPugs.length > 0) {
				return defaultPugs[0];
			}
		}
		...
		if ((idx = nick.indexOf(":")) != -1) {
			...
			if (pref == "irc") {
				...
				this.botRef.channelDisUsers.getUserId(nick, (cPartRef) => {
					this.getUserFinal(cPartRef, cPartRef.nick, callback, allowFromStats);
				});
			}
		} else if (
