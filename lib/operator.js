        ...
        if (this.botRef.isReady()) {
            ...
            if (this.logicState == 0) {
                ...
                if (this.gameRef.teams.length == 0) {
                    ...
                    wRef.texth('!vote [player]').text(' to vote for your captain (you got ' + this.gameRef.teams.length + ' votes).');
                                    ...
                                    switch (teamRef.captPartRef.captainSetMethod) {
                                        case 'avgpick' :
                                            if (teamRef.captPartRef.avgTotPick) {
                                                wRef.text(' ').texth('[').text('Avg Pick: ').text(teamRef.captPartRef.avgPick).texth('/').text(teamRef.captPartRef.avgTotPick).texth(']').text(' ');
                                            }
                                            break;
                                            
                                        case 'enforced' :
                                            wRef.text(' (enforced captain) ');
                                            break;

                                        case 'wanted' :
                                            wRef.text(' (wanted captain) ');
                                            break;

                                        case 'random' :
                                            wRef.text(' (random captain) ');
                                            break;
                                    }
                                }
