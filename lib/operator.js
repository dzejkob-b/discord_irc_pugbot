...
class Operator {
    constructor(botRef, options) {
        ...
        this.cmds = {
            ...
            'discord' : { 'auth' : 0, 'info' : 'List available discord players. Usage: !discord' },
    ...
    supplyCommandFn(partRef, cStk, privMsg) {
        ...
        let cRef, catRef, wRef, cmdName, isStart, reason, privPartRef = privMsg ? partRef : null;
        let result;
            ...
            case 'vote' :
                if (this.logicState == 1 && this.gameRef != null) {
                    ...
                    if (this.voteRef == null) {
                        this.voteRef = new VoteOperator(this.gameRef.restCat.getClone(), this.gameRef.teams.length);
                    }
                    ...
                    if (this.voteRef.catRef.findParticipant(partRef) == -1) {
                        ...
                        if (votePartRef == null) {
                            ...
                            let voteValue = votePartRef.tag == "nocapt" ? 0.5 : 1;
