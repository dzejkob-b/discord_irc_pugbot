...
class OpRule {
    ...
    exec(channelKey) {
        let operRef = this.parent, ruleNumb, userName, cStk = this.parent.cStk, partRef = this.parent.partRef, privPartRef = this.parent.privPartRef;
        ...
        if (!ruleNumb) {
            ...
            var mList = operRef.getTextCommand(channelKey, "rule" + ruleNumb, function(idx, m, data) {
